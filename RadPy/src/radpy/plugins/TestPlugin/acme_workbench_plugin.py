...
class AcmeWorkbenchPlugin(Plugin):
    ...
    def _perspectives_default(self):
        ...
        from perspective.api import FooPerspective
        from perspective.api import BarPerspective
    ...
    def _views_default(self):
        ...
        from view.api import BlackView, BlueView, GreenView
        from view.api import RedView, YellowView
