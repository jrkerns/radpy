...
from enthought.chaco.api import create_line_plot, add_default_axes, \
        ...
        ArrayPlotData, GridPlotContainer, Plot
...
#        container.overlays.append(self.title)
    ...
    def add_plot(self, label, beam):
        ...
        self.plotdata.set_data("xy",beam.Data.dose[0])
        centerplot = Plot(self.plotdata, padding=0)
        imgplot = centerplot.img_plot("xy"#, 
#                                xbounds=(beam.Data.y_axis[-1], beam.Data.y_axis[0]),
#                                ybounds=(beam.Data.z_axis[-1], beam.Data.z_axis[0]) 
                                )[0]
