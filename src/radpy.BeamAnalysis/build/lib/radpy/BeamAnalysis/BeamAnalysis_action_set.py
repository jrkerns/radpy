...
#        ToolBar(name='Barney')
    ...
    actions = [
        Action(
            ...
            class_name='radpy.BeamAnalysis.action.BeamAnalysis_action:NewPlotAction'
        ),

        Action(
            path='MenuBar/File', #group='XGroup',
            class_name='radpy.BeamAnalysis.action.BeamAnalysis_action:OpenDataFileAction'
        ),
        
        Action(
            path='MenuBar/Tools', #group='Fred',
            class_name='radpy.BeamAnalysis.action.BeamAnalysis_action:SmoothAction'
        ),
#        Action(
